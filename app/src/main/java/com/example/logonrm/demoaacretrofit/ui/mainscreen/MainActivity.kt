    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainViewModel.apiResponse.observe(this, Observer{
            ...
            if(apiResponse?.erro == null){
                ...
                tvRetorno.text = "Endereço ${apiResponse?.endereco?.logradouro.toString()} " +
                        "${apiResponse?.endereco?.bairro.toString()} - " +
                        "${apiResponse?.endereco?.uf.toString()}"


            }else{
                Log.i("TAG", apiResponse?.erro.toString())
